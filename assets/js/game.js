...
class Game {
  ...
  drawHorizLines() {
    ...
    this.h1y = 100;
    this.hline1.graphics.moveTo(0,this.h1y);
    this.hline1.graphics.lineTo(500,this.h1y);
    ...
    this.hline2.graphics.moveTo(0,200);
    this.hline2.graphics.lineTo(500,200);
    ...
    this.hline3.graphics.moveTo(0,300);
    this.hline3.graphics.lineTo(500,300);
    ...
    this.hline4.graphics.moveTo(0,400);
    this.hline4.graphics.lineTo(500,400);
    ...
    this.hline5.graphics.moveTo(0,500);
    this.hline5.graphics.lineTo(500,500);
